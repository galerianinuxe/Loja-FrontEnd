...
<html lang="pt-br">
    <head>
        ...
        <title>Galeria Ninuxe :: Selecione o Endereço de Entrega</title>
    </head>
    <body>
                ...
                <div class="container">
                    ...
                    <div class="d-flex justify-content-around flex-wrap border rounded-top pt-4 px-3">
                        <div class="mb-4 mx-2 flex-even">
                            ...
                            <label class="btn btn-outline-danger p-4 h-100 w-100 flex-even" for="end1">
                                <h3>
                        ...
                        <div class="mb-4 mx-2 flex-even">
                            ...
                            <label class="btn btn-outline-danger p-4 h-100 w-100 flex-even" for="end2">
                                <h3>
                        ...
                        <div class="mb-4 mx-2 flex-even">
                            ...
                            <label class="btn btn-outline-danger p-4 h-100 w-100 flex-even" for="end3">
                                <h3>
                    ...
                    <div class="text-end border border-top-0 rounded-bottom p-4 pb-0">                    
                        ...
                        <a href="fechamento_pagamento.php" class="btn btn-danger btn-lg ms-2 mb-4">Continuar</a>
                    </div>
                </div>
            </main>
