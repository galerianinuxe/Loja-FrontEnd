...
<html lang="pt-br">
    <head>
        ...
        <title>Galeria Ninuxe :: Fechamento Compra</title>
    </head>
    <body>
        <div class="d-flex flex-column wrapper">
            ...
            <main class="flex-fill">
                <div class="container">
                    ...
                    <h3>Confira os itens e clique em <b>Continuar</b> para prosseguir a <b>seleção do endereço de entrega</b>.</h3>
                    <ul class="list-group mb-3">
                        ...
                        <li class="list-group-item pt-3 pb-0">
                            <div class="text-end">
                                ...
                                <a href="fechamento_endereco.php" class="btn btn-danger btn-lg ms-2 mt-xs-3 mb-3">
                                    Continuar
                                </a>
                            </div>
                        </li>
