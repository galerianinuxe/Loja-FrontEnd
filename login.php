...
<head>
    ...
    <title>Galeria Ninuxe :: Login</title>
</head>
        ...
        <main class="flex-fill">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <form method="post" action="validaUser.php" name="logon" class="col-sm-10 col-md-8 col-lg-6">
                        <h1 class="mb-5 text-center">Identifique-se, por favor</h1>
