...
<html lang="pt-br">
    <head>
        ...
        <title>Galeria Ninuxe :: Carrinho</title>
    </head>
    <body>
                        ...
                        <li class="list-group-item py-3">
                            <div class="row g-3">
                                ...
                                align-self-center">
                                    ...
                                    <h5>
                                        Descrição em detalhes deste produto em específico.
                                    </h5>
                                </div>
                                <div class="col-6 offset-6 col-sm-6 offset-sm-6 col-md-4
                                    ...
                                    <div class="input-group">
                                        <button class="btn btn-outline-dark btn-sm" type="button">
                                            <i class="bi-caret-down" style="font-size: 16px;"></i>
                                        </button>
                                        <input type="text" class="form-control text-center border-dark" value="4">
                                        <button class="btn btn-outline-dark btn-sm" type="button">
                                            <i class="bi-caret-up" style="font-size: 16px;"></i>
                                        </button>
                                    ...
                                    <div class="text-end mt-2">
                                        <small class="text-secondary">Valor unitário: R$ 4,50</small><br>
                                        <span class="text-dark">Valor secondário: R$ 1,90</span>
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="list-group-item py-3">
                            <div class="text-end">
                                <h4 class="text-dark mb-3">
                                    Valor Total: R$ 149,35
                                </h4>
                                <a href="index.php" class="btn btn-outline-success btn-lg">
                                    Continuar comprando
                                </a>
                                <a href="fechamento_itens.php" class="btn btn-danger btn-lg ms-2 mt-xs-3">
                                    Fechar compra
                                </a>
                            </div>
                        </li>
