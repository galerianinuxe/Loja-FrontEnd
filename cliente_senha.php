...
<html lang="pt-br">
    <head>
        ...
        <title>Galeria Ninuxe :: Área do Cliente :: Alteração de Senha</title>
    </head>
    <body>
                    ...
                    <div class="row gx-3">
                        <div class="col-4">
                            <div class="list-group">
                                ...
                                <a href="cliente_senha.php" class="list-group-item list-group-item-action bg-danger text-light">
                        ...
                        <div class="col-8">
                            <form class="col-sm-12 col-md-8 col-lg-6">
                                ...
                                <button type="button" onclick="window.location.href='/confirmcadastrosenha.php'"
