...
<html lang="pt-br">
    <head>
        ...
        <title>Galeria Ninuxe :: Quem Somos</title>
    </head>
    <body>
        <div class="d-flex flex-column wrapper">
            ...
            <main class="flex-fill">
                <div class="container">
                    ...
                    <hr>
                    <p>
                        Galeria Ninuxe é uma loja virtual (e-commerce) fictícia criada como estudo de caso para o curso "Desenvolvimento de uma Loja Virtual com Bootstrap 5 e ASP.NET 5" disponibilizado gratuitamente pelo Prof. Ricardo Maroquio em seu canal no YouTube.
                    </p>
                    <p>
