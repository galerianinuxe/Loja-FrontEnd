...
<html lang="pt-br">
    <head>
        ...
        <title>Galeria Ninuxe :: Área do Cliente :: Favoritos</title>
    </head>
    <body>
                    ...
                    <div class="row gx-3 mb-3">
                        <div class="col-4">
                            <div class="list-group">
                                ...
                                <a href="cliente_favoritos.php" class="list-group-item list-group-item-action bg-danger text-light">
                                ...
                                <div class="col-12 col-sm-6 col-lg-4 col-xl-3">
                                    <div class="card text-center bg-light">
                                        ...
                                        <div class="card-footer">
                                            <a href="carrinho.php" class="btn btn-danger">
