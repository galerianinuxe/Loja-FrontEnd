...
<html lang="pt-br">
    <head>
        ...
        <title>Galeria Ninuxe :: Cadastro de Nova Senha</title>
    </head>
    <body>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <form class="col-sm-10 col-md-8 col-lg-6">
                            ...
                            <button type="button" onclick="window.location.href='/confirmcadastrosenha.php'" class="btn btn-lg btn-danger">Cadastrar Nova Senha</button>
                        </form>
                    </div>
                </div>
            </main>
